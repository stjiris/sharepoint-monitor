...
# This file is useful if in the future we want to use the xor_hash in the sharepoint
# as this method produces the exact same hash as in the sharepoint
# but for now, some files don't have xor_hash in the sharepoint so the hash check isn't useful
